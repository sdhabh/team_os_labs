...
void interrupt_handler(struct trapframe *tf) {
    ...
    8020041a:	e398                	sd	a4,0(a5)
            if(ticks%TICK_NUM == 0){// 当计数器加到100，输出一个`100ticks`表示触发了100次时钟中断
    ...
    80200452:	6398                	ld	a4,0(a5)
            	if(num == 10){    //判断打印次数，当打印次数为10时，调用<sbi.h>中的关机函数关机
...
void exception_handler(struct trapframe *tf) {
    ...
    802004c4:	b2850513          	addi	a0,a0,-1240 # 80200fe8 <etext+0x5cc>
    802004c8:	ba3ff0ef          	jal	ra,8020006a <cprintf>
		   cprintf("ebreak caught at 0x%016llx\n", tf->epc);
    802004cc:	10843583          	ld	a1,264(s0)
    802004d0:	00001517          	auipc	a0,0x1
    802004d4:	b3850513          	addi	a0,a0,-1224 # 80201008 <etext+0x5ec>
...
printnum(void (*putch)(int, void*), void *putdat,
    ...
    802005f0:	a3c78793          	addi	a5,a5,-1476 # 80201028 <etext+0x60c>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
    ...
    8020064c:	a14a8a93          	addi	s5,s5,-1516 # 8020105c <etext+0x640>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
    ...
    80200654:	be8b8b93          	addi	s7,s7,-1048 # 80201238 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
    ...
    802008aa:	7b260613          	addi	a2,a2,1970 # 80201058 <etext+0x63c>
    ...
    802008bc:	79060613          	addi	a2,a2,1936 # 80201048 <etext+0x62c>
    ...
    802008ce:	77640413          	addi	s0,s0,1910 # 80201040 <etext+0x624>
    ...
    80200958:	6ec40413          	addi	s0,s0,1772 # 80201040 <etext+0x624>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
    ...
    8020096e:	6d7a0a13          	addi	s4,s4,1751 # 80201041 <etext+0x625>
